...
<form name="myform" action="sear_product.php" method="post" class="demo">
	<table align="center" cellspacing="10">
	<tr><td> <h2 class="colo">- choose section -<br></h2></td></tr>
	<tr><h2>
	...
	<tr align="center"><td><input type="submit" style="width:100px; height:28px;font-face: 'Comic Sans MS'; font-size: larger; color: green; background-color: #FFFFFF; border: 2pt ridge lightgrey" name="submit" value="SEARCH"/></td></tr></h2>
	</table>
</form>
</center>
</body>
