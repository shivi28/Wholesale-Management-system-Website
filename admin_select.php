...
if($table=='employees')
{ 
	<a href="view_employees.php">Click here to view employees details</a><br>
	<a href="register_employees.php">Click here to edit employees details</a><br>
	<a href="search_employees.php">Click here to search employees details</a><br>
}
if($table=='customers')
{ 
...
if($table=='suppliers')
{ 
	<a href="view_suppliers.php">Click here to view employees details</a><br>
	<a href="register_suppliers.php">Click here to edit employees details</a><br>
}
if($table=='offers')
{ 
...
if($table=='supplying')
{ 
	<a href="view_supplying.php">Click here to view employees details</a><br>
	<a href="register_supplying.php">Click here to edit employees details</a><br>
}
if($table=='ordering')
{ 
